<template>
	<view class="editor">
		<div class="im-editor im-blank" id="im-editor" @blur="blurEvent" @input="inputText" @focus="inputFocus" ref="inputRef" contenteditable :placeholder="placeholder">
		</div>
	</view>
</template>
...
<script lang="ts" setup>
	 ...
	 * focus 点击输入框事件
	 */
	const emits = defineEmits(['input','focus','at'])
	...
	const inputFocus = (e: any) => {
		console.log(inputRef.value.selectionStart) //光标所在的位置
		emits('focus', e)
	}
