...
val GenSrcComponentsAqDialogClass = CreateVueComponent(GenSrcComponentsAqDialog::class.java, fun(): VueComponentOptions {
    return VueComponentOptions(name = "", inheritAttrs = GenSrcComponentsAqDialog.inheritAttrs, inject = GenSrcComponentsAqDialog.inject, props = GenSrcComponentsAqDialog.props, propsNeedCastKeys = GenSrcComponentsAqDialog.propsNeedCastKeys, emits = GenSrcComponentsAqDialog.emits, components = GenSrcComponentsAqDialog.components, styles = GenSrcComponentsAqDialog.styles);
}
, fun(instance): GenSrcComponentsAqDialog {
    return GenSrcComponentsAqDialog(instance);
}
);
...
open class UniAppConfig : AppConfig {
    override var name: String = "qa-chat-mobile";
