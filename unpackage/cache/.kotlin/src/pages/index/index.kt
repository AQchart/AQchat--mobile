...
open class GenPagesIndexIndex : BasePage {
    ...
    override fun `$render`(): VNode? {
        ...
        val _component_aq_dialog = resolveComponent("aq-dialog");
        return createElementVNode("view", utsMapOf("class" to "content"), utsArrayOf(
            ...
            createVNode(_component_aq_dialog, utsMapOf("visiable" to true, "fullscreen" to true))
        ));
    }
    ...
    companion object {
        ...
        var components: Map<String, CreateVueComponent> = utsMapOf("aqDialog" to GenSrcComponentsAqDialogClass);
    }
}
